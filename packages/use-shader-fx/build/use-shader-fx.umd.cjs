...
}`;const on=e=>{const u=l.useMemo(()=>new t.PlaneGeometry(2,2),[]),o=l.useMemo(()=>new t.ShaderMaterial({uniforms:{uTime:{value:0},scale:{value:0},timeStrength:{value:0},noiseOctaves:{value:0},fbmOctaves:{value:0},warpOctaves:{value:0},warpDirection:{value:new t.Vector2},warpStrength:{value:0}},vertexShader:tn,fragmentShader:rn}),[]),r=A(e,u,o,t.Mesh);return{material:o,mesh:r}},oe=Object.freeze({scale:.004,timeStrength:.3,noiseOctaves:2,fbmOctaves:2,warpOctaves:2,warpDirection:new t.Vector2(2,2),warpStrength:8,beat:!1}),an=({size:e,dpr:u,samples:o=0})=>{const r=l.useMemo(()=>new t.Scene,[]),{material:n,mesh:v}=on(r),f=I(e),[m,s]=D({scene:r,camera:f,size:e,dpr:u,samples:o}),[a,c]=F(oe);return[l.useCallback((p,g)=>{const{gl:x,clock:d}=p;return g&&c(g),i(n,"scale",a.scale),i(n,"timeStrength",a.timeStrength),i(n,"noiseOctaves",a.noiseOctaves),i(n,"fbmOctaves",a.fbmOctaves),i(n,"warpOctaves",a.warpOctaves),i(n,"warpDirection",a.warpDirection),i(n,"warpStrength",a.warpStrength),i(n,"uTime",a.beat||d.getElapsedTime()),s(x)},[s,n,c,a]),c,{scene:r,mesh:v,material:n,camera:f,renderTarget:m,output:m.texture}]};var un=`varying vec2 vUv;
...
}`;const Cn=e=>{const u=l.useMemo(()=>new t.PlaneGeometry(2,2),[]),o=l.useMemo(()=>new t.ShaderMaterial({uniforms:{u_texture:{value:new t.Texture},u_map:{value:new t.Texture},u_alphaMap:{value:new t.Texture},u_isAlphaMap:{value:!1},u_mapIntensity:{value:0},u_brightness:{value:new t.Vector3},u_min:{value:0},u_max:{value:.9},u_dodgeColor:{value:new t.Color(16777215)},u_isDodgeColor:{value:!1}},vertexShader:Sn,fragmentShader:_n}),[]),r=A(e,u,o,t.Mesh);return{material:o,mesh:r}},le={texture:new t.Texture,map:new t.Texture,alphaMap:!1,mapIntensity:.3,brightness:new t.Vector3(.5,.5,.5),min:0,max:1,dodgeColor:!1},Tn=({size:e,dpr:u,samples:o=0})=>{const r=l.useMemo(()=>new t.Scene,[]),{material:n,mesh:v}=Cn(r),f=I(e),[m,s]=D({scene:r,camera:f,size:e,dpr:u,samples:o}),[a,c]=F(le);return[l.useCallback((p,g)=>{const{gl:x}=p;return g&&c(g),i(n,"u_texture",a.texture),i(n,"u_map",a.map),i(n,"u_mapIntensity",a.mapIntensity),a.alphaMap?(i(n,"u_alphaMap",a.alphaMap),i(n,"u_isAlphaMap",!0)):i(n,"u_isAlphaMap",!1),i(n,"u_brightness",a.brightness),i(n,"u_min",a.min),i(n,"u_max",a.max),a.dodgeColor?(i(n,"u_dodgeColor",a.dodgeColor),i(n,"u_isDodgeColor",!0)):i(n,"u_isDodgeColor",!1),s(x)},[s,n,c,a]),c,{scene:r,mesh:v,material:n,camera:f,renderTarget:m,output:m.texture}]};var Pn=`varying vec2 vUv;
...
}`;const zn=e=>{const u=l.useMemo(()=>new t.PlaneGeometry(2,2),[]),o=l.useMemo(()=>new t.ShaderMaterial({uniforms:{u_texture:{value:new t.Texture},u_brightness:{value:new t.Vector3},u_min:{value:0},u_max:{value:1}},vertexShader:In,fragmentShader:Fn}),[]),r=A(e,u,o,t.Mesh);return{material:o,mesh:r}},ve={texture:new t.Texture,brightness:new t.Vector3(.5,.5,.5),min:0,max:1},Un=({size:e,dpr:u,samples:o=0})=>{const r=l.useMemo(()=>new t.Scene,[]),{material:n,mesh:v}=zn(r),f=I(e),[m,s]=D({scene:r,camera:f,size:e,dpr:u,samples:o}),[a,c]=F(ve);return[l.useCallback((p,g)=>{const{gl:x}=p;return g&&c(g),i(n,"u_texture",a.texture),i(n,"u_brightness",a.brightness),i(n,"u_min",a.min),i(n,"u_max",a.max),s(x)},[s,n,c,a]),c,{scene:r,mesh:v,material:n,camera:f,renderTarget:m,output:m.texture}]};var Vn=`varying vec2 vUv;
...
}`;const Nn=({scene:e,size:u,dpr:o})=>{const r=l.useMemo(()=>new t.PlaneGeometry(2,2),[]),n=l.useMemo(()=>new t.ShaderMaterial({uniforms:{u_texture:{value:new t.Texture},u_brightness:{value:1},u_saturation:{value:1}},vertexShader:qn,fragmentShader:jn}),[]),v=A(e,r,n,t.Mesh);return{material:n,mesh:v}},pe={texture:new t.Texture,brightness:1,saturation:1},Gn=({size:e,dpr:u,samples:o=0})=>{const r=l.useMemo(()=>new t.Scene,[]),{material:n,mesh:v}=Nn({scene:r,size:e,dpr:u}),f=I(e),[m,s]=D({scene:r,camera:f,size:e,dpr:u,samples:o}),[a,c]=F(pe);return[l.useCallback((p,g)=>{const{gl:x}=p;return g&&c(g),i(n,"u_texture",a.texture),i(n,"u_brightness",a.brightness),i(n,"u_saturation",a.saturation),s(x)},[n,s,a,c]),c,{scene:r,mesh:v,material:n,camera:f,renderTarget:m,output:m.texture}]};var Kn=`varying vec2 vUv;
...
}`;const Hn=({scene:e,size:u,dpr:o})=>{const r=l.useMemo(()=>new t.PlaneGeometry(2,2),[]),n=l.useMemo(()=>new t.ShaderMaterial({uniforms:{uResolution:{value:new t.Vector2},uTextureResolution:{value:new t.Vector2},uTexture:{value:new t.Texture}},vertexShader:Kn,fragmentShader:Xn}),[]),v=E(u,o);l.useEffect(()=>{i(n,"uResolution",v.clone())},[v,n]);const f=A(e,r,n,t.Mesh);return{material:n,mesh:f}},de={texture:new t.Texture},Yn=({size:e,dpr:u,samples:o=0})=>{const r=l.useMemo(()=>new t.Scene,[]),{material:n,mesh:v}=Hn({scene:r,size:e,dpr:u}),f=I(e),[m,s]=D({scene:r,camera:f,dpr:u,size:e,samples:o,isSizeUpdate:!0}),[a,c]=F(de);return[l.useCallback((p,g)=>{var d,w,M,b,T,C;const{gl:x}=p;return g&&c(g),i(n,"uTexture",a.texture),i(n,"uTextureResolution",[((M=(w=(d=a.texture)==null?void 0:d.source)==null?void 0:w.data)==null?void 0:M.width)||0,((C=(T=(b=a.texture)==null?void 0:b.source)==null?void 0:T.data)==null?void 0:C.height)||0]),s(x)},[s,n,a,c]),c,{scene:r,mesh:v,material:n,camera:f,renderTarget:m,output:m.texture}]};var Qn=`precision mediump float;
...
}`;const Jn=e=>{const u=l.useMemo(()=>new t.PlaneGeometry(2,2),[]),o=l.useMemo(()=>new t.ShaderMaterial({uniforms:{uTexture:{value:new t.Texture},uResolution:{value:new t.Vector2(0,0)},uBlurSize:{value:Q.blurSize}},vertexShader:Qn,fragmentShader:Zn}),[]),r=A(e,u,o,t.Mesh);return{material:o,mesh:r}},Q=Object.freeze({texture:new t.Texture,blurSize:3,blurPower:5}),et=({size:e,dpr:u,samples:o=0})=>{const r=l.useMemo(()=>new t.Scene,[]),{material:n,mesh:v}=Jn(r),f=I(e),m=l.useMemo(()=>({scene:r,camera:f,size:e,dpr:u,samples:o}),[r,f,e,u,o]),[s,a]=D(m),[c,h]=q(m),[p,g]=F(Q);return[l.useCallback((d,w)=>{var C,P,S,_,V,L;const{gl:M}=d;w&&g(w),i(n,"uTexture",p.texture),i(n,"uResolution",[((S=(P=(C=p.texture)==null?void 0:C.source)==null?void 0:P.data)==null?void 0:S.width)||0,((L=(V=(_=p.texture)==null?void 0:_.source)==null?void 0:V.data)==null?void 0:L.height)||0]),i(n,"uBlurSize",p.blurSize);let b=h(M);const T=p.blurPower;for(let O=0;O<T;O++)i(n,"uTexture",b),b=h(M);return a(M)},[a,h,n,g,p]),g,{scene:r,mesh:v,material:n,camera:f,renderTarget:s,output:s.texture}]};var nt=`varying vec2 vUv;
...
}`;const rt=e=>{const u=l.useMemo(()=>new t.PlaneGeometry(2,2),[]),o=l.useMemo(()=>new t.ShaderMaterial({uniforms:{uEpicenter:{value:j.epicenter},uProgress:{value:j.progress},uStrength:{value:j.strength},uWidth:{value:j.width},uMode:{value:0}},vertexShader:nt,fragmentShader:tt}),[]),r=A(e,u,o,t.Mesh);return{material:o,mesh:r}},j=Object.freeze({epicenter:new t.Vector2(0,0),progress:0,width:0,strength:0,mode:"center"}),ot=({size:e,dpr:u,samples:o=0})=>{const r=l.useMemo(()=>new t.Scene,[]),{material:n,mesh:v}=rt(r),f=I(e),[m,s]=D({scene:r,camera:f,size:e,dpr:u,samples:o,isSizeUpdate:!0}),[a,c]=F(j);return[l.useCallback((p,g)=>{const{gl:x}=p;return g&&c(g),i(n,"uEpicenter",a.epicenter),i(n,"uProgress",a.progress),i(n,"uWidth",a.width),i(n,"uStrength",a.strength),i(n,"uMode",a.mode==="center"?0:a.mode==="horizontal"?1:2),s(x)},[s,n,c,a]),c,{scene:r,mesh:v,material:n,camera:f,renderTarget:m,output:m.texture}]};var it=`varying vec2 vUv;
...
}`;const ut=({scene:e,size:u,dpr:o})=>{const r=l.useMemo(()=>new t.PlaneGeometry(2,2),[]),n=l.useMemo(()=>new t.ShaderMaterial({uniforms:{u_texture:{value:new t.Texture},u_resolution:{value:new t.Vector2},u_keyColor:{value:new t.Color},u_similarity:{value:0},u_smoothness:{value:0},u_spill:{value:0},u_color:{value:new t.Vector4},u_contrast:{value:0},u_brightness:{value:0},u_gamma:{value:0}},vertexShader:it,fragmentShader:at}),[]),v=E(u,o);l.useEffect(()=>{i(n,"u_resolution",v.clone())},[v,n]);const f=A(e,r,n,t.Mesh);return{material:n,mesh:f}},ge=Object.freeze({texture:new t.Texture,keyColor:new t.Color(65280),similarity:.2,smoothness:.1,spill:.2,color:new t.Vector4(1,1,1,1),contrast:1,brightness:0,gamma:1}),st=({size:e,dpr:u,samples:o=0})=>{const r=l.useMemo(()=>new t.Scene,[]),{material:n,mesh:v}=ut({scene:r,size:e,dpr:u}),f=I(e),[m,s]=D({scene:r,camera:f,size:e,dpr:u,samples:o}),[a,c]=F(ge);return[l.useCallback((p,g)=>{const{gl:x}=p;return g&&c(g),i(n,"u_texture",a.texture),i(n,"u_keyColor",a.keyColor),i(n,"u_similarity",a.similarity),i(n,"u_smoothness",a.smoothness),i(n,"u_spill",a.spill),i(n,"u_color",a.color),i(n,"u_contrast",a.contrast),i(n,"u_brightness",a.brightness),i(n,"u_gamma",a.gamma),s(x)},[s,n,c,a]),c,{scene:r,mesh:v,material:n,camera:f,renderTarget:m,output:m.texture}]},lt=({scene:e,geometry:u,material:o})=>{const r=A(e,u,o,t.Points),n=A(e,l.useMemo(()=>u.clone(),[u]),l.useMemo(()=>o.clone(),[o]),t.Mesh);return n.visible=!1,{points:r,interactiveMesh:n}};var ct=`uniform vec2 uResolution;
...
float getWobble(vec3 position)
{
	...
	return simplexNoise4d(vec4(
		...
		uTime * uWobbleTimeFrequency         
...
}`;const xe=process.env.NODE_ENV==="development",ye=(e,u,o,r,n)=>{var c;const v=o==="position"?"positionTarget":"uvTarget",f=o==="position"?"#usf <morphPositions>":"#usf <morphUvs>",m=o==="position"?"#usf <morphPositionTransition>":"#usf <morphUvTransition>",s=o==="position"?"positionsList":"uvsList",a=o==="position"?`
			...
			`:"newUv = mix(uvsList[baseIndex], uvsList[nextIndex], progress);";if(e.length>0){u.deleteAttribute(o),u.setAttribute(o,new t.BufferAttribute(e[0],n));let h="",p="";e.forEach((g,x)=>{u.setAttribute(`${v}${x}`,new t.BufferAttribute(g,n)),h+=`attribute vec${n} ${v}${x};
`,x===0?p+=`${v}${x}`:p+=`,${v}${x}`}),r=r.replace(`${f}`,h),r=r.replace(`${m}`,`vec${n} ${s}[${e.length}] = vec${n}[](${p});
				${a}
			`)}else r=r.replace(`${f}`,""),r=r.replace(`${m}`,""),(c=u==null?void 0:u.attributes[o])!=null&&c.array||xe&&console.error(`use-shader-fx:geometry.attributes.${o}.array is not found`);return r},Me=(e,u,o,r)=>{var v;let n=[];if(e&&e.length>0){(v=u==null?void 0:u.attributes[o])!=null&&v.array?n=[u.attributes[o].array,...e]:n=e;const f=Math.max(...n.map(m=>m.length));n.forEach((m,s)=>{if(m.length<f){const a=(f-m.length)/r,c=[],h=Array.from(m);for(let p=0;p<a;p++){const g=Math.floor(m.length/r*Math.random())*r;for(let x=0;x<r;x++)c.push(h[g+x])}n[s]=new Float32Array([...h,...c])}})}return n},mt=(e,u)=>{let o="";const r={};let n="mapArrayColor = ";return e&&e.length>0?(e.forEach((f,m)=>{const s=`vMapArrayIndex < ${m}.1`,a=`texture2D(uMapArray${m}, uv)`;n+=`( ${s} ) ? ${a} : `,o+=`
        uniform sampler2D uMapArray${m};
      `,r[`uMapArray${m}`]={value:f}}),n+="vec4(1.);",o+="bool isMapArray = true;",r.uMapArrayLength={value:e.length}):(n+="vec4(1.0);",o+="bool isMapArray = false;",r.uMapArrayLength={value:0}),{rewritedFragmentShader:u.replace("#usf <mapArraySwitcher>",n).replace("#usf <mapArrayUniforms>",o),mapArrayUniforms:r}},ft=({size:e,dpr:u,geometry:o,positions:r,uvs:n,mapArray:v})=>{const f=l.useMemo(()=>Me(r,o,"position",3),[r,o]),m=l.useMemo(()=>Me(n,o,"uv",2),[n,o]),s=l.useMemo(()=>{f.length!==m.length&&xe&&console.log("use-shader-fx:positions and uvs are not matched");const c=ye(m,o,"uv",ye(f,o,"position",ct,3),2).replace("#usf <getWobble>",he),h=mt(v,vt);return new t.ShaderMaterial({vertexShader:c,fragmentShader:h.rewritedFragmentShader,depthTest:!1,depthWrite:!1,transparent:!0,blending:t.AdditiveBlending,uniforms:{uResolution:{value:new t.Vector2(0,0)},uMorphProgress:{value:R.morphProgress},uBlurAlpha:{value:R.blurAlpha},uBlurRadius:{value:R.blurRadius},uPointSize:{value:R.pointSize},uPointAlpha:{value:R.pointAlpha},uPicture:{value:new t.Texture},uIsPicture:{value:!1},uAlphaPicture:{value:new t.Texture},uIsAlphaPicture:{value:!1},uColor0:{value:R.color0},uColor1:{value:R.color1},uColor2:{value:R.color2},uColor3:{value:R.color3},uMap:{value:new t.Texture},uIsMap:{value:!1},uAlphaMap:{value:new t.Texture},uIsAlphaMap:{value:!1},uTime:{value:0},uWobblePositionFrequency:{value:R.wobblePositionFrequency},uWobbleTimeFrequency:{value:R.wobbleTimeFrequency},uWobbleStrength:{value:R.wobbleStrength},uWarpPositionFrequency:{value:R.warpPositionFrequency},uWarpTimeFrequency:{value:R.warpTimeFrequency},uWarpStrength:{value:R.warpStrength},uDisplacement:{value:new t.Texture},uIsDisplacement:{value:!1},uDisplacementIntensity:{value:R.displacementIntensity},uDisplacementColorIntensity:{value:R.displacementColorIntensity},uSizeRandomIntensity:{value:R.sizeRandomIntensity},uSizeRandomTimeFrequency:{value:R.sizeRandomTimeFrequency},uSizeRandomMin:{value:R.sizeRandomMin},uSizeRandomMax:{value:R.sizeRandomMax},uDivergence:{value:R.divergence},uDivergencePoint:{value:R.divergencePoint},...h.mapArrayUniforms}})},[o,f,m,v]),a=E(e,u);return l.useEffect(()=>{i(s,"uResolution",a.clone())},[a,s]),{material:s,modifiedPositions:f,modifiedUvs:m}},be=({size:e,dpr:u,scene:o=!1,geometry:r,positions:n,uvs:v,mapArray:f})=>{const m=l.useMemo(()=>{const x=r||new t.SphereGeometry(1,32,32);return x.setIndex(null),x.deleteAttribute("normal"),x},[r]),{material:s,modifiedPositions:a,modifiedUvs:c}=ft({size:e,dpr:u,geometry:m,positions:n,uvs:v,mapArray:f}),{points:h,interactiveMesh:p}=lt({scene:o,geometry:m,material:s});return[l.useCallback((x,d)=>{x&&i(s,"uTime",(d==null?void 0:d.beat)||x.clock.getElapsedTime()),d!==void 0&&(i(s,"uMorphProgress",d.morphProgress),i(s,"uBlurAlpha",d.blurAlpha),i(s,"uBlurRadius",d.blurRadius),i(s,"uPointSize",d.pointSize),i(s,"uPointAlpha",d.pointAlpha),d.picture?(i(s,"uPicture",d.picture),i(s,"uIsPicture",!0)):d.picture===!1&&i(s,"uIsPicture",!1),d.alphaPicture?(i(s,"uAlphaPicture",d.alphaPicture),i(s,"uIsAlphaPicture",!0)):d.alphaPicture===!1&&i(s,"uIsAlphaPicture",!1),i(s,"uColor0",d.color0),i(s,"uColor1",d.color1),i(s,"uColor2",d.color2),i(s,"uColor3",d.color3),d.map?(i(s,"uMap",d.map),i(s,"uIsMap",!0)):d.map===!1&&i(s,"uIsMap",!1),d.alphaMap?(i(s,"uAlphaMap",d.alphaMap),i(s,"uIsAlphaMap",!0)):d.alphaMap===!1&&i(s,"uIsAlphaMap",!1),i(s,"uWobbleStrength",d.wobbleStrength),i(s,"uWobblePositionFrequency",d.wobblePositionFrequency),i(s,"uWobbleTimeFrequency",d.wobbleTimeFrequency),i(s,"uWarpStrength",d.warpStrength),i(s,"uWarpPositionFrequency",d.warpPositionFrequency),i(s,"uWarpTimeFrequency",d.warpTimeFrequency),d.displacement?(i(s,"uDisplacement",d.displacement),i(s,"uIsDisplacement",!0)):d.displacement===!1&&i(s,"uIsDisplacement",!1),i(s,"uDisplacementIntensity",d.displacementIntensity),i(s,"uDisplacementColorIntensity",d.displacementColorIntensity),i(s,"uSizeRandomIntensity",d.sizeRandomIntensity),i(s,"uSizeRandomTimeFrequency",d.sizeRandomTimeFrequency),i(s,"uSizeRandomMin",d.sizeRandomMin),i(s,"uSizeRandomMax",d.sizeRandomMax),i(s,"uDivergence",d.divergence),i(s,"uDivergencePoint",d.divergencePoint))},[s]),{points:h,interactiveMesh:p,positions:a,uvs:c}]},R=Object.freeze({morphProgress:0,blurAlpha:.9,blurRadius:.05,pointSize:.05,pointAlpha:1,picture:!1,alphaPicture:!1,color0:new t.Color(16711680),color1:new t.Color(65280),color2:new t.Color(255),color3:new t.Color(16776960),map:!1,alphaMap:!1,wobbleStrength:0,wobblePositionFrequency:.5,wobbleTimeFrequency:.5,warpStrength:0,warpPositionFrequency:.5,warpTimeFrequency:.5,displacement:!1,displacementIntensity:1,displacementColorIntensity:0,sizeRandomIntensity:0,sizeRandomTimeFrequency:.2,sizeRandomMin:.5,sizeRandomMax:1.5,divergence:0,divergencePoint:new t.Vector3(0),beat:!1}),pt=({size:e,dpr:u,samples:o=0,camera:r,geometry:n,positions:v,uvs:f})=>{const m=l.useMemo(()=>new t.Scene,[]),[s,{points:a,interactiveMesh:c,positions:h,uvs:p}]=be({scene:m,size:e,dpr:u,geometry:n,positions:v,uvs:f}),[g,x]=D({scene:m,camera:r,size:e,dpr:u,samples:o,depthBuffer:!0}),d=l.useCallback((M,b)=>(s(M,b),x(M.gl)),[x,s]),w=l.useCallback(M=>{s(null,M)},[s]);return[d,w,{scene:m,points:a,interactiveMesh:c,renderTarget:g,output:g.texture,positions:h,uvs:p}]};function dt(e,u=1e-4){u=Math.max(u,Number.EPSILON);const o={},r=e.getIndex(),n=e.getAttribute("position"),v=r?r.count:n.count;let f=0;const m=Object.keys(e.attributes),s={},a={},c=[],h=["getX","getY","getZ","getW"];for(let d=0,w=m.length;d<w;d++){const M=m[d];s[M]=[];const b=e.morphAttributes[M];b&&(a[M]=new Array(b.length).fill(0).map(()=>[]))}const p=Math.log10(1/u),g=Math.pow(10,p);for(let d=0;d<v;d++){const w=r?r.getX(d):d;let M="";for(let b=0,T=m.length;b<T;b++){const C=m[b],P=e.getAttribute(C),S=P.itemSize;for(let _=0;_<S;_++)M+=`${~~(P[h[_]](w)*g)},`}if(M in o)c.push(o[M]);else{for(let b=0,T=m.length;b<T;b++){const C=m[b],P=e.getAttribute(C),S=e.morphAttributes[C],_=P.itemSize,V=s[C],L=a[C];for(let O=0;O<_;O++){const k=h[O];if(V.push(P[k](w)),S)for(let B=0,Z=S.length;B<Z;B++)L[B].push(S[B][k](w))}}o[M]=f,c.push(f),f++}}const x=e.clone();for(let d=0,w=m.length;d<w;d++){const M=m[d],b=e.getAttribute(M),T=new b.array.constructor(s[M]),C=new $.BufferAttribute(T,b.itemSize,b.normalized);if(x.setAttribute(M,C),M in a)for(let P=0;P<a[M].length;P++){const S=e.morphAttributes[M][P],_=new S.array.constructor(a[M][P]),V=new $.BufferAttribute(_,S.itemSize,S.normalized);x.morphAttributes[M][P]=V}}return x.setIndex(c),x}var gt=`vec3 random3(vec3 c) {
...
totalDiffuse = mix( totalDiffuse, transmission.rgb, material.transmission );
...
#endif`;const we=e=>{let u=e;return u=u.replace("#include <beginnormal_vertex>",`
		vec3 objectNormal = usf_Normal;
		#ifdef USE_TANGENT
		vec3 objectTangent = vec3( tangent.xyz );
		#endif`),u=u.replace("#include <begin_vertex>",`
		vec3 transformed = usf_Position;`),u=u.replace("void main() {",`
		uniform float uTime;
		uniform float uWobblePositionFrequency;
		uniform float uWobbleTimeFrequency;
		uniform float uWobbleStrength;
		...
		// #usf <getWobble>
		void main() {`),u=u.replace("// #usf <getWobble>",`${he}`),u=u.replace("void main() {",`
		void main() {
