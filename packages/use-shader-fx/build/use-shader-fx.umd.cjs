...
}`;const lt=({scene:e,size:n,dpr:t,uniforms:r,onBeforeCompile:o})=>{const m=v.useMemo(()=>new i.PlaneGeometry(2,2),[]),s=v.useMemo(()=>{const g=new i.ShaderMaterial({uniforms:{uResolution:{value:new i.Vector2},uTextureResolution:{value:new i.Vector2},uTexture:{value:T},...r},vertexShader:ut,fragmentShader:st,...z});return o&&(g.onBeforeCompile=o),g},[o,r]),u=N(n,t);A(s)("uResolution",u.clone());const c=B(e,m,s,i.Mesh);return{material:s,mesh:c}},De=Object.freeze({texture:T}),ct=({size:e,dpr:n,samples:t,isSizeUpdate:r,uniforms:o,onBeforeCompile:m})=>{const s=O(n),u=v.useMemo(()=>new i.Scene,[]),{material:c,mesh:g}=lt({scene:u,size:e,dpr:s.shader,uniforms:o,onBeforeCompile:m}),d=L(e),[x,h]=W({scene:u,camera:d,dpr:s.fbo,size:e,samples:t,isSizeUpdate:r}),[a,f]=k(De),l=A(c),p=V(c);return[v.useCallback((S,b,M)=>{var w,R,U,F,I,P;const{gl:_}=S;return b&&f(b),l("uTexture",a.texture),l("uTextureResolution",[((U=(R=(w=a.texture)==null?void 0:w.source)==null?void 0:R.data)==null?void 0:U.width)||0,((P=(I=(F=a.texture)==null?void 0:F.source)==null?void 0:I.data)==null?void 0:P.height)||0]),p(M),h(_)},[h,l,a,f,p]),f,{scene:u,mesh:g,material:c,camera:d,renderTarget:x,output:x.texture}]};var vt=`precision highp float;
