...
}`;const an=()=>i.useMemo(()=>new a.ShaderMaterial({vertexShader:Q,fragmentShader:on,...F}),[]);var un=`precision highp float;
...
}`;const sn=({onBeforeInit:e})=>i.useMemo(()=>new a.ShaderMaterial({...V({uniforms:{uVelocity:{value:C},uSource:{value:C},texelSize:{value:new a.Vector2},dt:{value:Se},dissipation:{value:0}},vertexShader:Q,fragmentShader:un},e),...F}),[e]);var ln=`precision highp float;
...
}`;const cn=({onBeforeInit:e})=>i.useMemo(()=>new a.ShaderMaterial({...V({uniforms:{uVelocity:{value:null},texelSize:{value:new a.Vector2}},vertexShader:Q,fragmentShader:ln},e),...F}),[e]);var mn=`precision highp float;
...
}`;const vn=({onBeforeInit:e})=>i.useMemo(()=>new a.ShaderMaterial({...V({uniforms:{uPressure:{value:null},uDivergence:{value:null},texelSize:{value:new a.Vector2}},vertexShader:Q,fragmentShader:mn},e),...F}),[e]);var pn=`precision highp float;
...
}`;const fn=({onBeforeInit:e})=>i.useMemo(()=>new a.ShaderMaterial({...V({uniforms:{uVelocity:{value:null},texelSize:{value:new a.Vector2}},vertexShader:Q,fragmentShader:pn},e),...F}),[e]);var dn=`precision highp float;
...
}`;const gn=({onBeforeInit:e})=>i.useMemo(()=>new a.ShaderMaterial({...V({uniforms:{uVelocity:{value:null},uCurl:{value:null},curl:{value:0},dt:{value:Se},texelSize:{value:new a.Vector2}},vertexShader:Q,fragmentShader:dn},e),...F}),[e]);var hn=`precision highp float;
...
}`;const xn=({onBeforeInit:e})=>i.useMemo(()=>new a.ShaderMaterial({...V({uniforms:{uTexture:{value:C},value:{value:0},texelSize:{value:new a.Vector2}},vertexShader:Q,fragmentShader:hn},e),...F}),[e]);var Mn=`precision highp float;
...
}`;const yn=({onBeforeInit:e})=>i.useMemo(()=>new a.ShaderMaterial({...V({uniforms:{uPressure:{value:C},uVelocity:{value:C},texelSize:{value:new a.Vector2}},vertexShader:Q,fragmentShader:Mn},e),...F}),[e]);var bn=`precision highp float;
...
}`;const at=({scene:e,onBeforeInit:n})=>{const t=i.useMemo(()=>new a.PlaneGeometry(2,2),[]),r=i.useMemo(()=>new a.ShaderMaterial({...V({uniforms:{u_texture:{value:C},u_brightness:{value:pe.brightness},u_min:{value:pe.min},u_max:{value:pe.max}},vertexShader:rt,fragmentShader:ot},n),...F}),[n]),s=B(e,t,r,a.Mesh);return{material:r,mesh:s}},pe=Object.freeze({texture:C,brightness:new a.Vector3(.5,.5,.5),min:0,max:1}),ut=({size:e,dpr:n,renderTargetOptions:t,isSizeUpdate:r,onBeforeInit:s})=>{const m=O(n),c=i.useMemo(()=>new a.Scene,[]),{material:u,mesh:d}=at({scene:c,onBeforeInit:s}),p=E(e),[x,M]=k({scene:c,camera:p,size:e,dpr:m.fbo,isSizeUpdate:r,...t}),[o,h]=L(pe),l=P(u),v=A(u),f=i.useCallback((y,g)=>{h(y),v(g)},[h,v]);return[i.useCallback((y,g,S)=>{const{gl:_}=y;return f(g,S),l("u_texture",o.texture),l("u_brightness",o.brightness),l("u_min",o.min),l("u_max",o.max),M(_)},[M,l,o,f]),f,{scene:c,mesh:d,material:u,camera:p,renderTarget:x,output:x.texture}]};var it="#usf <planeVertex>",st=`precision highp float;
...
}`;const lt=({scene:e,onBeforeInit:n})=>{const t=i.useMemo(()=>new a.PlaneGeometry(2,2),[]),r=i.useMemo(()=>new a.ShaderMaterial({...V({uniforms:{u_texture:{value:C},uMap:{value:C},uMapIntensity:{value:Ce.mapIntensity}},vertexShader:it,fragmentShader:st},n),...F}),[n]),s=B(e,t,r,a.Mesh);return{material:r,mesh:s}},Ce=Object.freeze({texture:C,map:C,mapIntensity:.3}),ct=({size:e,dpr:n,renderTargetOptions:t,isSizeUpdate:r,onBeforeInit:s})=>{const m=O(n),c=i.useMemo(()=>new a.Scene,[]),{material:u,mesh:d}=lt({scene:c,onBeforeInit:s}),p=E(e),[x,M]=k({scene:c,camera:p,size:e,dpr:m.fbo,isSizeUpdate:r,...t}),[o,h]=L(Ce),l=P(u),v=A(u),f=i.useCallback((y,g)=>{h(y),v(g)},[h,v]);return[i.useCallback((y,g,S)=>{const{gl:_}=y;return f(g,S),l("u_texture",o.texture),l("uMap",o.map),l("uMapIntensity",o.mapIntensity),M(_)},[M,l,o,f]),f,{scene:c,mesh:d,material:u,camera:p,renderTarget:x,output:x.texture}]};var mt="#usf <planeVertex>",vt=`precision highp float;
...
}`;const pt=({scene:e,onBeforeInit:n})=>{const t=i.useMemo(()=>new a.PlaneGeometry(2,2),[]),r=i.useMemo(()=>new a.ShaderMaterial({...V({uniforms:{uTexture:{value:C},uMap:{value:C}},vertexShader:mt,fragmentShader:vt},n),...F}),[n]),s=B(e,t,r,a.Mesh);return{material:r,mesh:s}},Ae=Object.freeze({texture:C,map:C}),ft=({size:e,dpr:n,renderTargetOptions:t,isSizeUpdate:r,onBeforeInit:s})=>{const m=O(n),c=i.useMemo(()=>new a.Scene,[]),{material:u,mesh:d}=pt({scene:c,size:e,onBeforeInit:s}),p=E(e),[x,M]=k({scene:c,camera:p,size:e,dpr:m.fbo,isSizeUpdate:r,...t}),[o,h]=L(Ae),l=P(u),v=A(u),f=i.useCallback((y,g)=>{h(y),v(g)},[h,v]);return[i.useCallback((y,g,S)=>{const{gl:_}=y;return f(g,S),l("uTexture",o.texture),l("uMap",o.map),M(_)},[l,M,o,f]),f,{scene:c,mesh:d,material:u,camera:p,renderTarget:x,output:x.texture}]};var dt="#usf <planeVertex>",gt=`precision highp float;
...
}`;const bt=({scene:e,size:n,dpr:t,onBeforeInit:r})=>{const s=i.useMemo(()=>new a.PlaneGeometry(2,2),[]),m=i.useMemo(()=>new a.ShaderMaterial({...V({uniforms:{uResolution:{value:new a.Vector2},uTextureResolution:{value:new a.Vector2},uTexture:{value:C}},vertexShader:Mt,fragmentShader:yt},r),...F}),[r]),c=N(n,t);P(m)("uResolution",c.clone());const u=B(e,s,m,a.Mesh);return{material:m,mesh:u}},Ve=Object.freeze({texture:C}),St=({size:e,dpr:n,renderTargetOptions:t,isSizeUpdate:r,onBeforeInit:s})=>{const m=O(n),c=i.useMemo(()=>new a.Scene,[]),{material:u,mesh:d}=bt({scene:c,size:e,dpr:m.shader,onBeforeInit:s}),p=E(e),[x,M]=k({scene:c,camera:p,dpr:m.fbo,size:e,isSizeUpdate:r,...t}),[o,h]=L(Ve),l=P(u),v=A(u),f=i.useCallback((y,g)=>{h(y),v(g)},[h,v]);return[i.useCallback((y,g,S)=>{var D,I,z,R,j,w;const{gl:_}=y;return f(g,S),l("uTexture",o.texture),l("uTextureResolution",[((z=(I=(D=o.texture)==null?void 0:D.source)==null?void 0:I.data)==null?void 0:z.width)||0,((w=(j=(R=o.texture)==null?void 0:R.source)==null?void 0:j.data)==null?void 0:w.height)||0]),M(_)},[M,l,o,f]),f,{scene:c,mesh:d,material:u,camera:p,renderTarget:x,output:x.texture}]};var Ct="#usf <planeVertex>",_t=`precision highp float;
...
`,l===0?o+=`${m}${l}`:o+=`,${m}${l}`}),r=r.replace(`${c}`,M),r=r.replace(`${u}`,`vec${s} ${d}[${e.length}] = vec${s}[](${o});
      ...
      `,r[`uMapArray${u}`]={value:c}}),s+="vec4(1.);",t+="bool isMapArray = true;",r.uMapArrayLength={value:e.length}):(s+="vec4(1.0);",t+="bool isMapArray = false;",r.uMapArrayLength={value:0}),{rewritedFragmentShader:n.replace("#usf <mapArraySwitcher>",s).replace("#usf <mapArrayUniforms>",t),mapArrayUniforms:r}},Kt=({size:e,dpr:n,geometry:t,positions:r,uvs:s,mapArray:m,onBeforeInit:c})=>{const u=i.useMemo(()=>ze(r,t,"position",3),[r,t]),d=i.useMemo(()=>ze(s,t,"uv",2),[s,t]),p=i.useMemo(()=>{u.length!==d.length&&we&&console.log("use-shader-fx:positions and uvs are not matched");const M=Ie(d,t,"uv",Ie(u,t,"position",Wt,3),2),{rewritedFragmentShader:o,mapArrayUniforms:h}=Gt(m,Nt);return new a.ShaderMaterial({...V({uniforms:{uResolution:{value:new a.Vector2(0,0)},uMorphProgress:{value:U.morphProgress},uBlurAlpha:{value:U.blurAlpha},uBlurRadius:{value:U.blurRadius},uPointSize:{value:U.pointSize},uPointAlpha:{value:U.pointAlpha},uPicture:{value:C},uIsPicture:{value:!1},uAlphaPicture:{value:C},uIsAlphaPicture:{value:!1},uColor0:{value:U.color0},uColor1:{value:U.color1},uColor2:{value:U.color2},uColor3:{value:U.color3},uMap:{value:C},uIsMap:{value:!1},uAlphaMap:{value:C},uIsAlphaMap:{value:!1},uTime:{value:0},uWobblePositionFrequency:{value:U.wobblePositionFrequency},uWobbleTimeFrequency:{value:U.wobbleTimeFrequency},uWobbleStrength:{value:U.wobbleStrength},uWarpPositionFrequency:{value:U.warpPositionFrequency},uWarpTimeFrequency:{value:U.warpTimeFrequency},uWarpStrength:{value:U.warpStrength},uDisplacement:{value:C},uIsDisplacement:{value:!1},uDisplacementIntensity:{value:U.displacementIntensity},uDisplacementColorIntensity:{value:U.displacementColorIntensity},uSizeRandomIntensity:{value:U.sizeRandomIntensity},uSizeRandomTimeFrequency:{value:U.sizeRandomTimeFrequency},uSizeRandomMin:{value:U.sizeRandomMin},uSizeRandomMax:{value:U.sizeRandomMax},uDivergence:{value:U.divergence},uDivergencePoint:{value:U.divergencePoint},...h},vertexShader:M,fragmentShader:o},c),...F,blending:a.AdditiveBlending,transparent:!0})},[t,u,d,m,c]),x=N(e,n);return P(p)("uResolution",x.clone()),{material:p,modifiedPositions:u,modifiedUvs:d}},Oe=({size:e,dpr:n,scene:t=!1,geometry:r,positions:s,uvs:m,mapArray:c,onBeforeInit:u})=>{const d=O(n),p=i.useMemo(()=>{const y=r||new a.SphereGeometry(1,32,32);return y.setIndex(null),y.deleteAttribute("normal"),y},[r]),{material:x,modifiedPositions:M,modifiedUvs:o}=Kt({size:e,dpr:d.shader,geometry:p,positions:s,uvs:m,mapArray:c,onBeforeInit:u}),{points:h,interactiveMesh:l}=qt({scene:t,geometry:p,material:x}),v=P(x),f=A(x);return[i.useCallback((y,g,S)=>{y&&v("uTime",(g==null?void 0:g.beat)||y.clock.getElapsedTime()),g!==void 0&&(v("uMorphProgress",g.morphProgress),v("uBlurAlpha",g.blurAlpha),v("uBlurRadius",g.blurRadius),v("uPointSize",g.pointSize),v("uPointAlpha",g.pointAlpha),g.picture?(v("uPicture",g.picture),v("uIsPicture",!0)):g.picture===!1&&v("uIsPicture",!1),g.alphaPicture?(v("uAlphaPicture",g.alphaPicture),v("uIsAlphaPicture",!0)):g.alphaPicture===!1&&v("uIsAlphaPicture",!1),v("uColor0",g.color0),v("uColor1",g.color1),v("uColor2",g.color2),v("uColor3",g.color3),g.map?(v("uMap",g.map),v("uIsMap",!0)):g.map===!1&&v("uIsMap",!1),g.alphaMap?(v("uAlphaMap",g.alphaMap),v("uIsAlphaMap",!0)):g.alphaMap===!1&&v("uIsAlphaMap",!1),v("uWobbleStrength",g.wobbleStrength),v("uWobblePositionFrequency",g.wobblePositionFrequency),v("uWobbleTimeFrequency",g.wobbleTimeFrequency),v("uWarpStrength",g.warpStrength),v("uWarpPositionFrequency",g.warpPositionFrequency),v("uWarpTimeFrequency",g.warpTimeFrequency),g.displacement?(v("uDisplacement",g.displacement),v("uIsDisplacement",!0)):g.displacement===!1&&v("uIsDisplacement",!1),v("uDisplacementIntensity",g.displacementIntensity),v("uDisplacementColorIntensity",g.displacementColorIntensity),v("uSizeRandomIntensity",g.sizeRandomIntensity),v("uSizeRandomTimeFrequency",g.sizeRandomTimeFrequency),v("uSizeRandomMin",g.sizeRandomMin),v("uSizeRandomMax",g.sizeRandomMax),v("uDivergence",g.divergence),v("uDivergencePoint",g.divergencePoint),f(S))},[v,f]),{points:h,interactiveMesh:l,positions:M,uvs:o}]},U=Object.freeze({morphProgress:0,blurAlpha:.9,blurRadius:.05,pointSize:.05,pointAlpha:1,picture:!1,alphaPicture:!1,color0:new a.Color(16711680),color1:new a.Color(65280),color2:new a.Color(255),color3:new a.Color(16776960),map:!1,alphaMap:!1,wobbleStrength:0,wobblePositionFrequency:.5,wobbleTimeFrequency:.5,warpStrength:0,warpPositionFrequency:.5,warpTimeFrequency:.5,displacement:!1,displacementIntensity:1,displacementColorIntensity:0,sizeRandomIntensity:0,sizeRandomTimeFrequency:.2,sizeRandomMin:.5,sizeRandomMax:1.5,divergence:0,divergencePoint:new a.Vector3(0),beat:!1}),Ht=({size:e,dpr:n,isSizeUpdate:t,renderTargetOptions:r,camera:s,geometry:m,positions:c,uvs:u,onBeforeInit:d})=>{const p=O(n),x=i.useMemo(()=>new a.Scene,[]),[M,{points:o,interactiveMesh:h,positions:l,uvs:v}]=Oe({scene:x,size:e,dpr:n,geometry:m,positions:c,uvs:u,onBeforeInit:d}),[f,T]=k({scene:x,camera:s,size:e,dpr:p.fbo,isSizeUpdate:t,depthBuffer:!0,...r}),y=i.useCallback((S,_,D)=>(M(S,_,D),T(S.gl)),[T,M]),g=i.useCallback((S,_)=>{M(null,S,_)},[M]);return[y,g,{scene:x,points:o,interactiveMesh:h,renderTarget:f,output:f.texture,positions:l,uvs:v}]},Ue=e=>{e.vertexShader=e.vertexShader.replace("void main() {",`
		...
		`)},Xt=e=>{e.fragmentShader=e.fragmentShader.replace("#include <color_fragment>",`
