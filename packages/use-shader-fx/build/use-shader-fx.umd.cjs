(function(g,I){typeof exports=="object"&&typeof module<"u"?I(exports,require("three"),require("react")):typeof define=="function"&&define.amd?define(["exports","three","react"],I):(g=typeof globalThis<"u"?globalThis:g||self,I(g["use-shader-fx"]={},g.THREE,g.React))})(this,function(g,I,u){"use strict";function ae(t){const s=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(t){for(const r in t)if(r!=="default"){const e=Object.getOwnPropertyDescriptor(t,r);Object.defineProperty(s,r,e.get?e:{enumerable:!0,get:()=>t[r]})}}return s.default=t,Object.freeze(s)}const n=ae(I);var ie=`varying vec2 vUv;
...
}`;const F=(t,s=!1)=>{const r=s?t.width*s:t.width,e=s?t.height*s:t.height;return u.useMemo(()=>new n.Vector2(r,e),[r,e])},P=(t,s,r)=>{const e=u.useMemo(()=>new n.Mesh(s,r),[s,r]);return u.useEffect(()=>{t.add(e)},[t,e]),u.useEffect(()=>()=>{t.remove(e),s.dispose(),r.dispose()},[t,s,r,e]),e},i=(t,s,r)=>{t.uniforms&&t.uniforms[s]&&r!==void 0&&r!==null?t.uniforms[s].value=r:console.error(`Uniform key "${String(s)}" does not exist in the material. or "${String(s)}" is null | undefined`)},le=({scene:t,size:s,dpr:r})=>{const e=u.useMemo(()=>new n.PlaneGeometry(2,2),[]),a=u.useMemo(()=>new n.ShaderMaterial({uniforms:{uMap:{value:new n.Texture},uResolution:{value:new n.Vector2(0,0)},uAspect:{value:0},uTexture:{value:new n.Texture},uRadius:{value:0},uSmudge:{value:0},uDissipation:{value:0},uMotionBlur:{value:0},uMotionSample:{value:0},uMouse:{value:new n.Vector2(0,0)},uPrevMouse:{value:new n.Vector2(0,0)},uVelocity:{value:new n.Vector2(0,0)},uColor:{value:new n.Color(16777215)}},vertexShader:ie,fragmentShader:se}),[]),c=F(s,r);return u.useEffect(()=>{i(a,"uAspect",c.width/c.height),i(a,"uResolution",c.clone())},[c,a]),P(t,e,a),a},ce=(t,s)=>{const r=s,e=t/s,[a,c]=[r*e/2,r/2];return{width:a,height:c,near:-1e3,far:1e3}},_=t=>{const s=F(t),{width:r,height:e,near:a,far:c}=ce(s.x,s.y);return u.useMemo(()=>new n.OrthographicCamera(-r,r,e,-e,a,c),[r,e,a,c])},L={minFilter:n.LinearFilter,magFilter:n.LinearFilter,type:n.HalfFloatType,stencilBuffer:!1},R=({scene:t,camera:s,size:r,dpr:e=!1,isSizeUpdate:a=!1,samples:c=0,depthBuffer:v=!1,depthTexture:o=!1})=>{const l=u.useRef(),d=F(r,e);l.current=u.useMemo(()=>{const f=new n.WebGLRenderTarget(d.x,d.y,{...L,samples:c,depthBuffer:v});return o&&(f.depthTexture=new n.DepthTexture(d.x,d.y,n.FloatType)),f},[]),u.useLayoutEffect(()=>{var f;a&&((f=l.current)==null||f.setSize(d.x,d.y))},[d,a]),u.useEffect(()=>{const f=l.current;return()=>{f==null||f.dispose()}},[]);const m=u.useCallback((f,p)=>{const x=l.current;return f.setRenderTarget(x),p&&p({read:x.texture}),f.render(t,s),f.setRenderTarget(null),f.clear(),x.texture},[t,s]);return[l.current,m]},B=({scene:t,camera:s,size:r,dpr:e=!1,isSizeUpdate:a=!1,samples:c=0,depthBuffer:v=!1,depthTexture:o=!1})=>{const l=u.useRef({read:null,write:null,swap:function(){let p=this.read;this.read=this.write,this.write=p}}),d=F(r,e),m=u.useMemo(()=>{const p=new n.WebGLRenderTarget(d.x,d.y,{...L,samples:c,depthBuffer:v}),x=new n.WebGLRenderTarget(d.x,d.y,{...L,samples:c,depthBuffer:v});return o&&(p.depthTexture=new n.DepthTexture(d.x,d.y,n.FloatType),x.depthTexture=new n.DepthTexture(d.x,d.y,n.FloatType)),{read:p,write:x}},[]);l.current.read=m.read,l.current.write=m.write,u.useLayoutEffect(()=>{var p,x;a&&((p=l.current.read)==null||p.setSize(d.x,d.y),(x=l.current.write)==null||x.setSize(d.x,d.y))},[d,a]),u.useEffect(()=>{const p=l.current;return()=>{var x,h;(x=p.read)==null||x.dispose(),(h=p.write)==null||h.dispose()}},[]);const f=u.useCallback((p,x)=>{var y;const h=l.current;return p.setRenderTarget(h.write),x&&x({read:h.read.texture,write:h.write.texture}),p.render(t,s),h.swap(),p.setRenderTarget(null),p.clear(),(y=h.read)==null?void 0:y.texture},[t,s]);return[{read:l.current.read,write:l.current.write},f]},z=()=>{const t=u.useRef(new n.Vector2(0,0)),s=u.useRef(new n.Vector2(0,0)),r=u.useRef(0),e=u.useRef(new n.Vector2(0,0)),a=u.useRef(!1);return u.useCallback(v=>{const o=performance.now(),l=v.clone();r.current===0&&(r.current=o,t.current=l);const d=Math.max(1,o-r.current);r.current=o,e.current.copy(l).sub(t.current).divideScalar(d);const m=e.current.length()>0,f=a.current?t.current.clone():l;return!a.current&&m&&(a.current=!0),t.current=l,{currentPointer:l,prevPointer:f,diffPointer:s.current.subVectors(l,f),velocity:e.current,isVelocityUpdate:m}},[])},b=t=>{const s=a=>Object.values(a).some(c=>typeof c=="function"),r=u.useRef(s(t)?t:structuredClone(t)),e=u.useCallback(a=>{for(const c in a){const v=c;v in r.current&&a[v]!==void 0&&a[v]!==null?r.current[v]=a[v]:console.error(`"${String(v)}" does not exist in the params. or "${String(v)}" is null | undefined`)}},[]);return[r.current,e]},j={texture:new n.Texture,radius:.05,smudge:0,dissipation:1,motionBlur:0,motionSample:5,color:new n.Color(16777215)},ve=({size:t,dpr:s})=>{const r=u.useMemo(()=>new n.Scene,[]),e=le({scene:r,size:t,dpr:s}),a=_(t),c=z(),[v,o]=B({scene:r,camera:a,size:t,dpr:s}),[l,d]=b(j);return[u.useCallback((f,p)=>{const{gl:x,pointer:h}=f;p&&d(p),i(e,"uTexture",l.texture),i(e,"uRadius",l.radius),i(e,"uSmudge",l.smudge),i(e,"uDissipation",l.dissipation),i(e,"uMotionBlur",l.motionBlur),i(e,"uMotionSample",l.motionSample),i(e,"uColor",l.color);const{currentPointer:y,prevPointer:T,velocity:D}=c(h);return i(e,"uMouse",y),i(e,"uPrevMouse",T),i(e,"uVelocity",D),o(x,({read:U})=>{i(e,"uMap",U)})},[e,c,o,l,d]),d,{scene:r,material:e,camera:a,renderTarget:v}]};var fe=`varying vec2 vUv;
...
}`;const Ie=()=>u.useMemo(()=>new n.ShaderMaterial({uniforms:{uTarget:{value:new n.Texture},aspectRatio:{value:0},color:{value:new n.Vector3},point:{value:new n.Vector2},radius:{value:0},texelSize:{value:new n.Vector2}},vertexShader:A,fragmentShader:Ee}),[]),Le=({scene:t,size:s,dpr:r})=>{const e=u.useMemo(()=>new n.PlaneGeometry(2,2),[]),a=Te(),c=a.clone(),v=Pe(),o=Ve(),l=we(),d=Re(),m=Ce(),f=Ae(),p=Oe(),x=Ie(),h=u.useMemo(()=>({vorticityMaterial:o,curlMaterial:v,advectionMaterial:l,divergenceMaterial:d,pressureMaterial:m,clearMaterial:f,gradientSubtractMaterial:p,splatMaterial:x}),[o,v,l,d,m,f,p,x]),y=F(s,r);u.useEffect(()=>{i(h.splatMaterial,"aspectRatio",y.x/y.y);for(const w of Object.values(h))i(w,"texelSize",new n.Vector2(1/y.x,1/y.y))},[y,h]);const T=P(t,e,a);u.useEffect(()=>{a.dispose(),T.material=c},[a,T,c]),u.useEffect(()=>()=>{for(const w of Object.values(h))w.dispose()},[h]);const D=u.useCallback(w=>{T.material=w,T.material.needsUpdate=!0},[T]);return[h,D]},X={density_dissipation:.98,velocity_dissipation:.99,velocity_acceleration:10,pressure_dissipation:.9,pressure_iterations:20,curl_strength:35,splat_radius:.002,fluid_color:new n.Vector3(1,1,1)},ze=({size:t,dpr:s})=>{const r=u.useMemo(()=>new n.Scene,[]),[e,a]=Le({scene:r,size:t,dpr:s}),c=_(t),v=z(),o=u.useMemo(()=>({scene:r,camera:c,size:t}),[r,c,t]),[l,d]=B(o),[m,f]=B(o),[p,x]=R(o),[h,y]=R(o),[T,D]=B(o),w=u.useRef(0),U=u.useRef(new n.Vector2(0,0)),O=u.useRef(new n.Vector3(0,0,0)),[C,M]=b(X);return[u.useCallback((bn,te)=>{const{gl:V,pointer:Cn,clock:N,size:re}=bn;te&&M(te),w.current===0&&(w.current=N.getElapsedTime());const oe=Math.min((N.getElapsedTime()-w.current)/3,.02);w.current=N.getElapsedTime();const k=d(V,({read:S})=>{a(e.advectionMaterial),i(e.advectionMaterial,"uVelocity",S),i(e.advectionMaterial,"uSource",S),i(e.advectionMaterial,"dt",oe),i(e.advectionMaterial,"dissipation",C.velocity_dissipation)}),Dn=f(V,({read:S})=>{a(e.advectionMaterial),i(e.advectionMaterial,"uVelocity",k),i(e.advectionMaterial,"uSource",S),i(e.advectionMaterial,"dissipation",C.density_dissipation)}),{currentPointer:Pn,diffPointer:Un,isVelocityUpdate:Vn,velocity:Fn}=v(Cn);Vn&&(d(V,({read:S})=>{a(e.splatMaterial),i(e.splatMaterial,"uTarget",S),i(e.splatMaterial,"point",Pn);const E=Un.multiply(U.current.set(re.width,re.height).multiplyScalar(C.velocity_acceleration));i(e.splatMaterial,"color",O.current.set(E.x,E.y,1)),i(e.splatMaterial,"radius",C.splat_radius)}),f(V,({read:S})=>{a(e.splatMaterial),i(e.splatMaterial,"uTarget",S);const E=typeof C.fluid_color=="function"?C.fluid_color(Fn):C.fluid_color;i(e.splatMaterial,"color",E)}));const An=x(V,()=>{a(e.curlMaterial),i(e.curlMaterial,"uVelocity",k)});d(V,({read:S})=>{a(e.vorticityMaterial),i(e.vorticityMaterial,"uVelocity",S),i(e.vorticityMaterial,"uCurl",An),i(e.vorticityMaterial,"curl",C.curl_strength),i(e.vorticityMaterial,"dt",oe)});const Bn=y(V,()=>{a(e.divergenceMaterial),i(e.divergenceMaterial,"uVelocity",k)});D(V,({read:S})=>{a(e.clearMaterial),i(e.clearMaterial,"uTexture",S),i(e.clearMaterial,"value",C.pressure_dissipation)}),a(e.pressureMaterial),i(e.pressureMaterial,"uDivergence",Bn);let ue;for(let S=0;S<C.pressure_iterations;S++)ue=D(V,({read:E})=>{i(e.pressureMaterial,"uPressure",E)});return d(V,({read:S})=>{a(e.gradientSubtractMaterial),i(e.gradientSubtractMaterial,"uPressure",ue),i(e.gradientSubtractMaterial,"uVelocity",S)}),Dn},[e,a,x,f,y,v,D,d,M,C]),M,{scene:r,materials:e,camera:c,renderTarget:{velocity:l,density:m,curl:p,divergence:h,pressure:T}}]},$e=({scale:t,max:s,texture:r,scene:e})=>{const a=u.useRef([]),c=u.useMemo(()=>new n.PlaneGeometry(t,t),[t]),v=u.useMemo(()=>new n.MeshBasicMaterial({map:r??null,transparent:!0,blending:n.AdditiveBlending,depthTest:!1,depthWrite:!1}),[r]);return u.useEffect(()=>{for(let o=0;o<s;o++){const l=new n.Mesh(c.clone(),v.clone());l.rotateZ(2*Math.PI*Math.random()),l.visible=!1,e.add(l),a.current.push(l)}},[c,v,e,s]),u.useEffect(()=>()=>{a.current.forEach(o=>{o.geometry.dispose(),Array.isArray(o.material)?o.material.forEach(l=>l.dispose()):o.material.dispose(),e.remove(o)}),a.current=[]},[e]),a.current},H={frequency:.01,rotation:.05,fadeout_speed:.9,scale:.3,alpha:.6},Ne=({texture:t,scale:s=64,max:r=100,size:e})=>{const a=u.useMemo(()=>new n.Scene,[]),c=$e({scale:s,max:r,texture:t,scene:a}),v=_(e),o=z(),[l,d]=R({scene:a,camera:v,size:e}),[m,f]=b(H),p=u.useRef(0);return[u.useCallback((h,y)=>{const{gl:T,pointer:D,size:w}=h;y&&f(y);const{currentPointer:U,diffPointer:O}=o(D);if(m.frequency<O.length()){const M=c[p.current];M.visible=!0,M.position.set(U.x*(w.width/2),U.y*(w.height/2),0),M.scale.x=M.scale.y=0,M.material.opacity=m.alpha,p.current=(p.current+1)%r}return c.forEach(M=>{if(M.visible){const $=M.material;M.rotation.z+=m.rotation,$.opacity*=m.fadeout_speed,M.scale.x=m.fadeout_speed*M.scale.x+m.scale,M.scale.y=M.scale.x,$.opacity<.002&&(M.visible=!1)}}),d(T)},[d,c,o,r,m,f]),f,{scene:a,camera:v,meshArr:c,renderTarget:l}]};var ke=`varying vec2 vUv;
...
}`;const Qe=({params:t,size:s,scene:r})=>{r.children.length>0&&(r.children.forEach(e=>{e instanceof n.Mesh&&(e.geometry.dispose(),e.material.dispose())}),r.remove(...r.children)),t.texture.forEach((e,a)=>{const c=new n.Mesh(new n.PlaneGeometry(1,1),new n.ShaderMaterial({vertexShader:Ze,fragmentShader:Je,transparent:!0,uniforms:{u_texture:{value:e},u_textureResolution:{value:new n.Vector2(0,0)},u_resolution:{value:new n.Vector2(0,0)},u_borderRadius:{value:t.boderRadius[a]?t.boderRadius[a]:0}}}));r.add(c)})},en=()=>{const t=u.useRef([]),s=u.useRef([]);return u.useCallback(({isIntersectingRef:e,isIntersectingOnceRef:a,params:c})=>{t.current.length>0&&t.current.forEach((o,l)=>{o.unobserve(s.current[l])}),s.current=[],t.current=[];const v=new Array(c.dom.length).fill(!1);e.current=[...v],a.current=[...v],c.dom.forEach((o,l)=>{const d=f=>{f.forEach(p=>{c.onIntersect[l]&&c.onIntersect[l](p),e.current[l]=p.isIntersecting})},m=new IntersectionObserver(d,{rootMargin:"0px",threshold:0});m.observe(o),t.current.push(m),s.current.push(o)})},[])},nn=()=>{const t=u.useRef([]),s=u.useCallback(({params:r,size:e,resolutionRef:a,scene:c,isIntersectingRef:v})=>{c.children.length!==t.current.length&&(t.current=new Array(c.children.length)),c.children.forEach((o,l)=>{const d=r.dom[l];if(!d)throw new Error("DOM is null.");const m=d.getBoundingClientRect();if(t.current[l]=m,o.scale.set(m.width,m.height,1),o.position.set(m.left+m.width*.5-e.width*.5,-m.top-m.height*.5+e.height*.5,0),v.current[l]&&(r.rotation[l]&&o.rotation.copy(r.rotation[l]),o instanceof n.Mesh)){const f=o.material;i(f,"u_texture",r.texture[l]),i(f,"u_textureResolution",r.resolution[l]),i(f,"u_resolution",a.current.set(m.width,m.height)),i(f,"u_borderRadius",r.boderRadius[l]?r.boderRadius[l]:0)}})},[]);return[t.current,s]},tn=()=>{const t=u.useRef([]),s=u.useRef([]),r=u.useCallback((e,a=!1)=>{t.current.forEach((v,o)=>{v&&(s.current[o]=!0)});const c=a?[...s.current]:[...t.current];return e<0?c:c[e]},[]);return{isIntersectingRef:t,isIntersectingOnceRef:s,isIntersecting:r}},K={texture:[],dom:[],resolution:[],boderRadius:[],rotation:[],onIntersect:[]},rn=({size:t,dpr:s},r=[])=>{const e=u.useMemo(()=>new n.Scene,[]),a=_(t),[c,v]=R({scene:e,camera:a,size:t,dpr:s,isSizeUpdate:!0}),[o,l]=b(K),[d,m]=nn(),f=u.useRef(new n.Vector2(0,0)),[p,x]=u.useState(!0);u.useEffect(()=>{x(!0)},r);const h=en(),{isIntersectingOnceRef:y,isIntersectingRef:T,isIntersecting:D}=tn();return[u.useCallback((U,O)=>{const{gl:C,size:M}=U;return O&&l(O),Ke(o),p&&(Qe({params:o,size:M,scene:e}),h({isIntersectingRef:T,isIntersectingOnceRef:y,params:o}),x(!1)),m({params:o,size:M,resolutionRef:f,scene:e,isIntersectingRef:T}),v(C)},[v,l,h,m,p,e,o,y,T]),l,{scene:e,camera:a,renderTarget:c,isIntersecting:D,DOMRects:d}]};var on=`precision mediump float;
...
}`;const wn=t=>{const s=u.useMemo(()=>new n.PlaneGeometry(2,2),[]),r=u.useMemo(()=>new n.ShaderMaterial({uniforms:{u_texture:{value:new n.Texture},u_map:{value:new n.Texture},u_mapIntensity:{value:0}},vertexShader:Tn,fragmentShader:Sn}),[]);return P(t,s,r),r},ne={texture:new n.Texture,map:new n.Texture,mapIntensity:.3},_n=({size:t,dpr:s})=>{const r=u.useMemo(()=>new n.Scene,[]),e=wn(r),a=_(t),[c,v]=R({scene:r,camera:a,size:t,dpr:s}),[o,l]=b(ne);return[u.useCallback((m,f)=>{const{gl:p}=m;return f&&l(f),i(e,"u_texture",o.texture),i(e,"u_map",o.map),i(e,"u_mapIntensity",o.mapIntensity),v(p)},[v,e,l,o]),l,{scene:r,material:e,camera:a,renderTarget:c}]},Rn=({scene:t,camera:s,size:r,dpr:e=!1,isSizeUpdate:a=!1},c)=>{const v=u.useRef([]),o=F(r,e);v.current=u.useMemo(()=>Array.from({length:c},()=>new n.WebGLRenderTarget(o.x,o.y,L)),[c]),u.useLayoutEffect(()=>{a&&v.current.forEach(d=>d.setSize(o.x,o.y))},[o,a]),u.useEffect(()=>{const d=v.current;return()=>{d.forEach(m=>m.dispose())}},[c]);const l=u.useCallback((d,m,f)=>{const p=v.current[m];return d.setRenderTarget(p),f&&f({read:p.texture}),d.render(t,s),d.setRenderTarget(null),d.clear(),p.texture},[t,s]);return[v.current,l]};g.BLENDING_PARAMS=W,g.BRIGHTNESSPICKER_PARAMS=Q,g.BRUSH_PARAMS=j,g.COLORSTRATA_PARAMS=ee,g.DOMSYNCER_PARAMS=K,g.DUOTONE_PARAMS=G,g.FLUID_PARAMS=X,g.FXBLENDING_PARAMS=ne,g.FXTEXTURE_PARAMS=Y,g.NOISE_PARAMS=q,g.RIPPLE_PARAMS=H,g.SIMPLEBLUR_PARAMS=Z,g.WAVE_PARAMS=J,g.setUniform=i,g.useAddMesh=P,g.useBlending=ye,g.useBrightnessPicker=gn,g.useBrush=ve,g.useCamera=_,g.useColorStrata=Mn,g.useCopyTexture=Rn,g.useDomSyncer=rn,g.useDoubleFBO=B,g.useDuoTone=pe,g.useFluid=ze,g.useFxBlending=_n,g.useFxTexture=We,g.useNoise=qe,g.useParams=b,g.usePointer=z,g.useResolution=F,g.useRipple=Ne,g.useSimpleBlur=sn,g.useSingleFBO=R,g.useWave=fn,Object.defineProperty(g,Symbol.toStringTag,{value:"Module"})});
