...
}`;const me=t=>{const i=a.useMemo(()=>new n.PlaneGeometry(2,2),[]),r=a.useMemo(()=>new n.ShaderMaterial({uniforms:{uTexture:{value:new n.Texture},uColor0:{value:new n.Color(16777215)},uColor1:{value:new n.Color(0)}},vertexShader:fe,fragmentShader:de}),[]);return D(t,i,r),r},N={texture:new n.Texture,color0:new n.Color(16777215),color1:new n.Color(0)},pe=({size:t,dpr:i})=>{const r=a.useMemo(()=>new n.Scene,[]),e=me(r),u=_(t),[l,v]=R({scene:r,camera:u,size:t,dpr:i}),[o,c]=b(N);return[a.useCallback((d,m)=>{const{gl:g}=d;return m&&c(m),s(e,"uTexture",o.texture),s(e,"uColor0",o.color0),s(e,"uColor1",o.color1),v(g)},[v,e,c,o]),c,{scene:r,material:e,camera:u,renderTarget:l}]};var ge=`varying vec2 vUv;
...
}`;const Te=()=>a.useMemo(()=>new n.ShaderMaterial({vertexShader:A,fragmentShader:Me,depthTest:!1,depthWrite:!1}),[]);var we=`precision highp float;
...
void main () {
	...
	gl_FragColor.a = 1.0;
}`;const Se=()=>a.useMemo(()=>new n.ShaderMaterial({uniforms:{uVelocity:{value:new n.Texture},uSource:{value:new n.Texture},texelSize:{value:new n.Vector2},dt:{value:0},dissipation:{value:0}},vertexShader:A,fragmentShader:we}),[]);var _e=`precision highp float;
...
}`;const Ie=()=>a.useMemo(()=>new n.ShaderMaterial({uniforms:{uTarget:{value:new n.Texture},aspectRatio:{value:0},color:{value:new n.Vector3},point:{value:new n.Vector2},radius:{value:0},texelSize:{value:new n.Vector2}},vertexShader:A,fragmentShader:Ee}),[]),Le=({scene:t,size:i,dpr:r})=>{const e=a.useMemo(()=>new n.PlaneGeometry(2,2),[]),u=Te(),l=u.clone(),v=Pe(),o=Ve(),c=Se(),f=Re(),d=Ce(),m=Ae(),g=Oe(),x=Ie(),h=a.useMemo(()=>({vorticityMaterial:o,curlMaterial:v,advectionMaterial:c,divergenceMaterial:f,pressureMaterial:d,clearMaterial:m,gradientSubtractMaterial:g,splatMaterial:x}),[o,v,c,f,d,m,g,x]),y=F(i,r);a.useEffect(()=>{s(h.splatMaterial,"aspectRatio",y.x/y.y);for(const M of Object.values(h))s(M,"texelSize",new n.Vector2(1/y.x,1/y.y))},[y,h]);const S=D(t,e,u);a.useEffect(()=>{u.dispose(),S.material=l},[u,S,l]),a.useEffect(()=>()=>{for(const M of Object.values(h))M.dispose()},[h]);const C=a.useCallback(M=>{S.material=M,S.material.needsUpdate=!0},[S]);return[h,C]},X={density_dissipation:.98,velocity_dissipation:.99,velocity_acceleration:10,pressure_dissipation:.9,pressure_iterations:20,curl_strength:35,splat_radius:.002,fluid_color:new n.Vector3(1,1,1)},ze=({size:t,dpr:i})=>{const r=a.useMemo(()=>new n.Scene,[]),[e,u]=Le({scene:r,size:t,dpr:i}),l=_(t),v=z(),o=a.useMemo(()=>({scene:r,camera:l,size:t}),[r,l,t]),[c,f]=B(o),[d,m]=B(o),[g,x]=R(o),[h,y]=R(o),[S,C]=B(o),M=a.useRef(0),U=a.useRef(new n.Vector2(0,0)),O=a.useRef(new n.Vector3(0,0,0)),[P,T]=b(X);return[a.useCallback((bn,te)=>{const{gl:V,pointer:Cn,clock:k,size:re}=bn;te&&T(te),M.current===0&&(M.current=k.getElapsedTime());const oe=Math.min((k.getElapsedTime()-M.current)/3,.02);M.current=k.getElapsedTime();const G=f(V,({read:w})=>{u(e.advectionMaterial),s(e.advectionMaterial,"uVelocity",w),s(e.advectionMaterial,"uSource",w),s(e.advectionMaterial,"dt",oe),s(e.advectionMaterial,"dissipation",P.velocity_dissipation)}),Dn=m(V,({read:w})=>{u(e.advectionMaterial),s(e.advectionMaterial,"uVelocity",G),s(e.advectionMaterial,"uSource",w),s(e.advectionMaterial,"dissipation",P.density_dissipation)}),{currentPointer:Pn,diffPointer:Un,isVelocityUpdate:Vn,velocity:Fn}=v(Cn);Vn&&(f(V,({read:w})=>{u(e.splatMaterial),s(e.splatMaterial,"uTarget",w),s(e.splatMaterial,"point",Pn);const E=Un.multiply(U.current.set(re.width,re.height).multiplyScalar(P.velocity_acceleration));s(e.splatMaterial,"color",O.current.set(E.x,E.y,1)),s(e.splatMaterial,"radius",P.splat_radius)}),m(V,({read:w})=>{u(e.splatMaterial),s(e.splatMaterial,"uTarget",w);const E=typeof P.fluid_color=="function"?P.fluid_color(Fn):P.fluid_color;s(e.splatMaterial,"color",E)}));const An=x(V,()=>{u(e.curlMaterial),s(e.curlMaterial,"uVelocity",G)});f(V,({read:w})=>{u(e.vorticityMaterial),s(e.vorticityMaterial,"uVelocity",w),s(e.vorticityMaterial,"uCurl",An),s(e.vorticityMaterial,"curl",P.curl_strength),s(e.vorticityMaterial,"dt",oe)});const Bn=y(V,()=>{u(e.divergenceMaterial),s(e.divergenceMaterial,"uVelocity",G)});C(V,({read:w})=>{u(e.clearMaterial),s(e.clearMaterial,"uTexture",w),s(e.clearMaterial,"value",P.pressure_dissipation)}),u(e.pressureMaterial),s(e.pressureMaterial,"uDivergence",Bn);let ue;for(let w=0;w<P.pressure_iterations;w++)ue=C(V,({read:E})=>{s(e.pressureMaterial,"uPressure",E)});return f(V,({read:w})=>{u(e.gradientSubtractMaterial),s(e.gradientSubtractMaterial,"uPressure",ue),s(e.gradientSubtractMaterial,"uVelocity",w)}),Dn},[e,u,x,m,y,v,C,f,T,P]),T,{scene:r,materials:e,camera:l,renderTarget:{velocity:c,density:d,curl:g,divergence:h,pressure:S}}]},$e=({scale:t,max:i,texture:r,scene:e})=>{const u=a.useRef([]),l=a.useMemo(()=>new n.PlaneGeometry(t,t),[t]),v=a.useMemo(()=>new n.MeshBasicMaterial({map:r??null,transparent:!0,blending:n.AdditiveBlending,depthTest:!1,depthWrite:!1}),[r]);return a.useEffect(()=>{for(let o=0;o<i;o++){const c=new n.Mesh(l.clone(),v.clone());c.rotateZ(2*Math.PI*Math.random()),c.visible=!1,e.add(c),u.current.push(c)}},[l,v,e,i]),a.useEffect(()=>()=>{u.current.forEach(o=>{o.geometry.dispose(),Array.isArray(o.material)?o.material.forEach(c=>c.dispose()):o.material.dispose(),e.remove(o)}),u.current=[]},[e]),u.current},H={frequency:.01,rotation:.05,fadeout_speed:.9,scale:.3,alpha:.6},ke=({texture:t,scale:i=64,max:r=100,size:e})=>{const u=a.useMemo(()=>new n.Scene,[]),l=$e({scale:i,max:r,texture:t,scene:u}),v=_(e),o=z(),[c,f]=R({scene:u,camera:v,size:e}),[d,m]=b(H),g=a.useRef(0);return[a.useCallback((h,y)=>{const{gl:S,pointer:C,size:M}=h;y&&m(y);const{currentPointer:U,diffPointer:O}=o(C);if(d.frequency<O.length()){const T=l[g.current];T.visible=!0,T.position.set(U.x*(M.width/2),U.y*(M.height/2),0),T.scale.x=T.scale.y=0,T.material.opacity=d.alpha,g.current=(g.current+1)%r}return l.forEach(T=>{if(T.visible){const $=T.material;T.rotation.z+=d.rotation,$.opacity*=d.fadeout_speed,T.scale.x=d.fadeout_speed*T.scale.x+d.scale,T.scale.y=T.scale.x,$.opacity<.002&&(T.visible=!1)}}),f(S)},[f,l,o,r,d,m]),m,{scene:u,camera:v,meshArr:l,renderTarget:c}]};var Ge=`varying vec2 vUv;
...
}`;const Sn=t=>{const i=a.useMemo(()=>new n.PlaneGeometry(2,2),[]),r=a.useMemo(()=>new n.ShaderMaterial({uniforms:{u_texture:{value:new n.Texture},u_map:{value:new n.Texture},u_mapIntensity:{value:0}},vertexShader:Tn,fragmentShader:wn}),[]);return D(t,i,r),r},ne={texture:new n.Texture,map:new n.Texture,mapIntensity:.3},_n=({size:t,dpr:i})=>{const r=a.useMemo(()=>new n.Scene,[]),e=Sn(r),u=_(t),[l,v]=R({scene:r,camera:u,size:t,dpr:i}),[o,c]=b(ne);return[a.useCallback((d,m)=>{const{gl:g}=d;return m&&c(m),s(e,"u_texture",o.texture),s(e,"u_map",o.map),s(e,"u_mapIntensity",o.mapIntensity),v(g)},[v,e,c,o]),c,{scene:r,material:e,camera:u,renderTarget:l}]},Rn=({scene:t,camera:i,size:r,dpr:e=!1,isSizeUpdate:u=!1},l)=>{const v=a.useRef([]),o=F(r,e);v.current=a.useMemo(()=>Array.from({length:l},()=>new n.WebGLRenderTarget(o.x,o.y,L)),[l]),a.useLayoutEffect(()=>{u&&v.current.forEach(f=>f.setSize(o.x,o.y))},[o,u]),a.useEffect(()=>{const f=v.current;return()=>{f.forEach(d=>d.dispose())}},[l]);const c=a.useCallback((f,d,m)=>{const g=v.current[d];return f.setRenderTarget(g),m&&m({read:g.texture}),f.render(t,i),f.setRenderTarget(null),f.clear(),g.texture},[t,i]);return[v.current,c]};p.BLENDING_PARAMS=W,p.BRIGHTNESSPICKER_PARAMS=Q,p.BRUSH_PARAMS=j,p.COLORSTRATA_PARAMS=ee,p.DOMSYNCER_PARAMS=K,p.DUOTONE_PARAMS=N,p.FLUID_PARAMS=X,p.FXBLENDING_PARAMS=ne,p.FXTEXTURE_PARAMS=Y,p.NOISE_PARAMS=q,p.RIPPLE_PARAMS=H,p.SIMPLEBLUR_PARAMS=Z,p.WAVE_PARAMS=J,p.setUniform=s,p.useAddMesh=D,p.useBlending=ye,p.useBrightnessPicker=gn,p.useBrush=ve,p.useCamera=_,p.useColorStrata=Mn,p.useCopyTexture=Rn,p.useDomSyncer=rn,p.useDoubleFBO=B,p.useDuoTone=pe,p.useFluid=ze,p.useFxBlending=_n,p.useFxTexture=We,p.useNoise=qe,p.useParams=b,p.usePointer=z,p.useResolution=F,p.useRipple=ke,p.useSimpleBlur=sn,p.useSingleFBO=R,p.useWave=fn,Object.defineProperty(p,Symbol.toStringTag,{value:"Module"})});
