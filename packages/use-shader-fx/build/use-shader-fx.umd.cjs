(function(p,E){typeof exports=="object"&&typeof module<"u"?E(exports,require("three"),require("react")):typeof define=="function"&&define.amd?define(["exports","three","react"],E):(p=typeof globalThis<"u"?globalThis:p||self,E(p["use-shader-fx"]={},p.THREE,p.React))})(this,function(p,E,o){"use strict";function ee(t){const a=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(t){for(const r in t)if(r!=="default"){const e=Object.getOwnPropertyDescriptor(t,r);Object.defineProperty(a,r,e.get?e:{enumerable:!0,get:()=>t[r]})}}return a.default=t,Object.freeze(a)}const n=ee(E);var ne=`varying vec2 vUv;
...
}`;const se=t=>{const a=o.useMemo(()=>new n.PlaneGeometry(2,2),[]),r=o.useMemo(()=>new n.ShaderMaterial({uniforms:{uTexture:{value:new n.Texture},uColor0:{value:new n.Color(16777215)},uColor1:{value:new n.Color(0)}},vertexShader:ae,fragmentShader:ue}),[]);return O(t,a,r),r},j={texture:new n.Texture,color0:new n.Color(16777215),color1:new n.Color(0)},le=({size:t,dpr:a})=>{const r=o.useMemo(()=>new n.Scene,[]),e=se(r),i=_(t),[c,v]=D({scene:r,camera:i,size:t,dpr:a}),[s,l]=V(j);return[o.useCallback((d,m)=>{const{gl:g}=d;return m&&l(m),u(e,"uTexture",s.texture),u(e,"uColor0",s.color0),u(e,"uColor1",s.color1),v(g)},[v,e,l,s]),l,{scene:r,material:e,camera:i,renderTarget:c}]};var ce=`varying vec2 vUv;
...
}`;const fe=t=>{const a=o.useMemo(()=>new n.PlaneGeometry(2,2),[]),r=o.useMemo(()=>new n.ShaderMaterial({uniforms:{uTime:{value:0},uTexture:{value:new n.Texture},uNoiseMap:{value:new n.Texture},distortionStrength:{value:0},fogEdge0:{value:0},fogEdge1:{value:.9},fogColor:{value:new n.Color(16777215)}},vertexShader:ce,fragmentShader:ve}),[]);return O(t,a,r),r},q={texture:new n.Texture,noiseMap:new n.Texture,distortionStrength:.03,fogEdge0:0,fogEdge1:.9,fogColor:new n.Color(16777215)},de=({size:t,dpr:a})=>{const r=o.useMemo(()=>new n.Scene,[]),e=fe(r),i=_(t),[c,v]=D({scene:r,camera:i,size:t,dpr:a}),[s,l]=V(q);return[o.useCallback((d,m)=>{const{gl:g,clock:M}=d;return m&&l(m),u(e,"uTime",M.getElapsedTime()),u(e,"uTexture",s.texture),u(e,"uNoiseMap",s.noiseMap),u(e,"distortionStrength",s.distortionStrength),u(e,"fogEdge0",s.fogEdge0),u(e,"fogEdge1",s.fogEdge1),u(e,"fogColor",s.fogColor),v(g)},[v,e,l,s]),l,{scene:r,material:e,camera:i,renderTarget:c}]};var C=`varying vec2 vUv;
varying vec2 vL;
varying vec2 vR;
varying vec2 vT;
varying vec2 vB;
...
}`;const pe=()=>o.useMemo(()=>new n.ShaderMaterial({vertexShader:C,fragmentShader:me,depthTest:!1,depthWrite:!1}),[]);var ge=`precision highp float;
...
void main () {
	...
	gl_FragColor.a = 1.0;
}`;const xe=()=>o.useMemo(()=>new n.ShaderMaterial({uniforms:{uVelocity:{value:new n.Texture},uSource:{value:new n.Texture},texelSize:{value:new n.Vector2},dt:{value:0},dissipation:{value:0}},vertexShader:C,fragmentShader:ge}),[]);var ye=`precision highp float;
...
}`;const Ie=({scene:t,size:a,dpr:r})=>{const e=o.useMemo(()=>new n.PlaneGeometry(2,2),[]),i=o.useMemo(()=>new n.ShaderMaterial({uniforms:{uResolution:{value:new n.Vector2},uImageResolution:{value:new n.Vector2},uTexture0:{value:new n.Texture},uTexture1:{value:new n.Texture},uNoiseMap:{value:new n.Texture},noiseStrength:{value:0},progress:{value:0},dirX:{value:0},dirY:{value:0}},vertexShader:Ae,fragmentShader:Le}),[]),c=U(a,r);return o.useEffect(()=>{i.uniforms.uResolution.value=c.clone()},[c,i]),O(t,e,i),i},X={texture0:new n.Texture,texture1:new n.Texture,imageResolution:new n.Vector2(0,0),noiseMap:new n.Texture,noiseStrength:0,progress:0,dir:new n.Vector2(0,0)},Ne=({size:t,dpr:a})=>{const r=o.useMemo(()=>new n.Scene,[]),e=Ie({scene:r,size:t,dpr:a}),i=_(t),[c,v]=D({scene:r,camera:i,dpr:a,size:t,isSizeUpdate:!0}),[s,l]=V(X);return[o.useCallback((d,m)=>{const{gl:g}=d;return m&&l(m),u(e,"uTexture0",s.texture0),u(e,"uTexture1",s.texture1),u(e,"uImageResolution",s.imageResolution),u(e,"uNoiseMap",s.noiseMap),u(e,"noiseStrength",s.noiseStrength),u(e,"progress",s.progress),u(e,"dirX",s.dir.x),u(e,"dirY",s.dir.y),v(g)},[v,e,s,l]),l,{scene:r,material:e,camera:i,renderTarget:c}]};var $e=`varying vec2 vUv;
...
}`;const ke=t=>{const a=o.useMemo(()=>new n.PlaneGeometry(2,2),[]),r=o.useMemo(()=>new n.ShaderMaterial({uniforms:{uTime:{value:0},timeStrength:{value:0},noiseOctaves:{value:0},fbmOctaves:{value:0}},vertexShader:$e,fragmentShader:ze}),[]);return O(t,a,r),r},Y={timeStrength:.3,noiseOctaves:8,fbmOctaves:3},Ge=({size:t,dpr:a})=>{const r=o.useMemo(()=>new n.Scene,[]),e=ke(r),i=_(t),[c,v]=D({scene:r,camera:i,size:t,dpr:a}),[s,l]=V(Y);return[o.useCallback((d,m)=>{const{gl:g,clock:M}=d;return m&&l(m),u(e,"timeStrength",s.timeStrength),u(e,"noiseOctaves",s.noiseOctaves),u(e,"fbmOctaves",s.fbmOctaves),u(e,"uTime",M.getElapsedTime()),v(g)},[v,e,l,s]),l,{scene:r,material:e,camera:i,renderTarget:c}]};p.BRUSH_PARAMS=G,p.DUOTONE_PARAMS=j,p.FOGPROJECTION_PARAMS=q,p.FRUID_PARAMS=W,p.NOISE_PARAMS=Y,p.RIPPLE_PARAMS=H,p.TRANSITIONBG_PARAMS=X,p.setUniform=u,p.useAddMesh=O,p.useBrush=ie,p.useCamera=_,p.useDoubleFBO=A,p.useDuoTone=le,p.useFogProjection=de,p.useFruid=Fe,p.useNoise=Ge,p.useParams=V,p.usePointer=L,p.useResolution=U,p.useRipple=Ee,p.useSingleFBO=D,p.useTransitionBg=Ne,Object.defineProperty(p,Symbol.toStringTag,{value:"Module"})});
