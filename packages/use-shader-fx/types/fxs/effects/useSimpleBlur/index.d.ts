 ...
 */
export declare const useSimpleBlur: ({ size, dpr, samples, renderTargetOptions, isSizeUpdate, onBeforeInit, }: HooksProps) => HooksReturn<SimpleBlurParams, SimpleBlurObject, CustomParams>;
