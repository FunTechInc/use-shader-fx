 ...
 */
export declare const useMotionBlur: ({ size, dpr, renderTargetOptions, isSizeUpdate, onBeforeInit, }: HooksProps) => HooksReturn<MotionBlurParams, MotionBlurObject, CustomParams>;
