 ...
 */
export declare const useMorphParticles: ({ size, dpr, samples, isSizeUpdate, renderTargetOptions, camera, geometry, positions, uvs, onBeforeInit, }: HooksProps3D & UseCreateMorphParticlesProps) => HooksReturn<MorphParticlesParams, MorphParticlesObject, CustomParams>;
