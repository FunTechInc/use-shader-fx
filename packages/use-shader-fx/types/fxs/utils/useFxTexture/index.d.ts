 ...
 */
export declare const useFxTexture: ({ size, dpr, samples, renderTargetOptions, isSizeUpdate, onBeforeInit, }: HooksProps) => HooksReturn<FxTextureParams, FxTextureObject, CustomParams>;
