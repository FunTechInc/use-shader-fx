 ...
 */
export declare const useFxTexture: ({ size, dpr, renderTargetOptions, isSizeUpdate, onBeforeInit, }: HooksProps) => HooksReturn<FxTextureParams, FxTextureObject, CustomParams>;
