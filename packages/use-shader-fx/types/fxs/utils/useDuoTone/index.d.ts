 ...
 */
export declare const useDuoTone: ({ size, dpr, renderTargetOptions, isSizeUpdate, onBeforeInit, }: HooksProps) => HooksReturn<DuoToneParams, DuoToneObject, CustomParams>;
