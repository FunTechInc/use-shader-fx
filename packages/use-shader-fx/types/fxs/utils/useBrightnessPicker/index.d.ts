 ...
 */
export declare const useBrightnessPicker: ({ size, dpr, samples, isSizeUpdate, onBeforeCompile, }: HooksProps) => HooksReturn<BrightnessPickerParams, BrightnessPickerObject>;
