 ...
 */
export declare const useBrightnessPicker: ({ size, dpr, renderTargetOptions, isSizeUpdate, onBeforeInit, }: HooksProps) => HooksReturn<BrightnessPickerParams, BrightnessPickerObject, CustomParams>;
