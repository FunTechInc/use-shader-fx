 ...
 */
export declare const useAlphaBlending: ({ size, dpr, samples, isSizeUpdate, onBeforeInit, }: HooksProps) => HooksReturn<AlphaBlendingParams, AlphaBlendingObject, CustomParams>;
