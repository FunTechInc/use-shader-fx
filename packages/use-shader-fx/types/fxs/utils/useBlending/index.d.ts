 ...
 */
export declare const useBlending: ({ size, dpr, samples, renderTargetOptions, isSizeUpdate, onBeforeInit, }: HooksProps) => HooksReturn<BlendingParams, BlendingObject, CustomParams>;
