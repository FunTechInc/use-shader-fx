 ...
 */
export declare const useFxBlending: ({ size, dpr, samples, renderTargetOptions, isSizeUpdate, onBeforeInit, }: HooksProps) => HooksReturn<FxBlendingParams, FxBlendingObject, CustomParams>;
