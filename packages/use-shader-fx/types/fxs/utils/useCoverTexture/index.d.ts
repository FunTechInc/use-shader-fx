 ...
 */
export declare const useCoverTexture: ({ size, dpr, renderTargetOptions, isSizeUpdate, onBeforeInit, }: HooksProps) => HooksReturn<CoverTextureParams, CoverTextureObject, CustomParams>;
