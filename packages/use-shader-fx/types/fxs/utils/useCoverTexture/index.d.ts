 ...
 */
export declare const useCoverTexture: ({ size, dpr, samples, renderTargetOptions, isSizeUpdate, onBeforeInit, }: HooksProps) => HooksReturn<CoverTextureParams, CoverTextureObject, CustomParams>;
