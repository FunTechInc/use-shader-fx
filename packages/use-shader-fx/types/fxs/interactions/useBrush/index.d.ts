 ...
 */
export declare const useBrush: ({ size, dpr, samples, renderTargetOptions, isSizeUpdate, onBeforeInit, }: HooksProps) => HooksReturn<BrushParams, BrushObject, CustomParams>;
