 ...
 */
export declare const useBlank: ({ size, dpr, samples, renderTargetOptions, isSizeUpdate, onBeforeInit, }: HooksProps) => HooksReturn<BlankParams, BlankObject, CustomParams>;
