 ...
 */
export declare const useColorStrata: ({ size, dpr, samples, renderTargetOptions, isSizeUpdate, onBeforeInit, }: HooksProps) => HooksReturn<ColorStrataParams, ColorStrataObject, CustomParams>;
