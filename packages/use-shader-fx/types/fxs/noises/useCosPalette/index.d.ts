 ...
 */
export declare const useCosPalette: ({ size, dpr, samples, renderTargetOptions, isSizeUpdate, onBeforeInit, }: HooksProps) => HooksReturn<CosPaletteParams, ColorPaletteObject, CustomParams>;
