 ...
 */
export declare const useMarble: ({ size, dpr, samples, renderTargetOptions, isSizeUpdate, onBeforeInit, }: HooksProps) => HooksReturn<MarbleParams, MarbleObject, CustomParams>;
