 ...
 */
export declare const useDomSyncer: ({ size, dpr, samples, isSizeUpdate, renderTargetOptions, onBeforeInit, }: HooksProps, dependencies?: import("react").DependencyList) => HooksReturn<DomSyncerParams, DomSyncerObject, CustomParams>;
