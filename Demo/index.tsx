...
大事なのは
	- createKitを疎結合にできるかどうか
		- create Kitっていうフォルダをzipでつくって、それをnpm scriptでダウンロードして、unzipするみたいな。
	- 単体テストしやすいように
	- ぱっと見でどういうfxかがわかるような印象的なdemoにしたい
		- そう考えると、storybookにするまでもないかなって感じ。あくまでfxだけなので。lilをもっとわかりやすく調整するべきか！
		- Demoも追加しやすいようにする
===============================================*/
